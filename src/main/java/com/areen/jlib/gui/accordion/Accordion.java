 ...
 * true) has the same behaviour as setFixedSize(index, true, null)
 *
 * @author Matthew
 */
public class Accordion extends JComponent implements PropertyChangeListener {
    ...
    private void configurePopupMenu() {
        ...
        // expand all
        JMenuItem expandAllMenuItem = new JMenuItem("Expand all panes");
        ...
        // collapse all
        JMenuItem collapseAllMenuItem = new JMenuItem("Collapse all panes");
        ...
        // reset sizes menu item
        JMenuItem resetSizesMenuItem = new JMenuItem("Restore default pane sizes");
        resetSizesMenuItem.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                model.clearAllDimensions();

            }
        });
        popupMenu.add(resetSizesMenuItem);
    }
