 ...
 */
package com.areen.jlib.gui.layout;
...
/**
 *
 * A vertical layout manager similar to java.awt.FlowLayout. Like FlowLayout components do not expand to fill
 * available space except when the horizontal alignment is
 * <code>BOTH</code> in which case components are stretched horizontally. Unlike FlowLayout, components will
 * not wrap to form another column if there isn't enough space vertically. VerticalLayout can optionally
