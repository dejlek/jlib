...
public class SmallArrayInt extends SmallArray {
    ...
    public void set(int argIdx, int argValue) throws SmallArrayException, ArrayIndexOutOfBoundsException {
        ...
        if (argValue >= maxVal)
            throw new SmallArrayException("Value is greater than the maximum value allowed for an element. Got " 
    ...
    public String wlz(int argValue) {
        ...
        return "00000000000000000000000000000000".substring(binString.length()) + binString + " : " + argValue;
    }
